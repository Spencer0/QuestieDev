...
QuestieAuto.disallowedQuests = {
    ...
    [3375] = true, -- Talvash del Kissel (Replacement Phial);
    [2948] = true, -- Talvash del Kissel (Gnome Improvement);
    [2199] = true, -- Talvash del Kissel (Lore for a Price)
    [2950] = true, -- Nogg (Nogg's Ring Redo);
    [4781] = true, -- Menara Voidrender (Components for the Enchanted Gold Bloodrobe);
    [4083] = true, -- Spectral Chalice (The Spectral Chalice);
    [5166] = true, -- Catalogue of the Wayward (Breastplate of the Chromatic Flight);
    [5167] = true  -- Catalogue of the Wayward (Legplates of the Chromatic Defier);
}
